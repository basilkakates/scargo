...
pub fn configure(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("/api")
            ...
            .service(super::shared_link_ingest::get_source)
            .service(super::shared_link_ingest::put_source)
            .service(super::shared_link_ingest::delete_source)
            .service(super::shared_link_ingest::pause_source)
            .service(super::shared_link_ingest::sync_now)
